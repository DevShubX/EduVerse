...
interface ResourseAttachmentFormProps {
...
const ResourseAttachmentForm = ({initialData,courseId}:ResourseAttachmentFormProps) => {
...
export default ResourseAttachmentForm